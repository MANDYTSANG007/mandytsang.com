  ...
  return (
      <Router>
        ...
        <Routes>
          ...
          <Route path="/portfolio/turtle-sighting-app" element={<TurtleSightingApp />} />
          <Route path="/portfolio/drone-delivery-app" element={<DroneDeliveryApp />} />
          <Route path="/portfolio/sales-management-app" element={<SalesManagementApp />} />
        </Routes>
        <Footer />
      </Router>
  );
